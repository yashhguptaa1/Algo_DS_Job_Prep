package STACKS.Category_S1.L946_ValidateStackSequences;
 ...
 * Input Format
 * 
 * An integer n Two arrays of length n denoting pushed and popped array
 * Constraints
 * 
 ...
 * Sample Input 0
 * 
 * 5 1 2 3 4 5 4 5 3 2 1 Sample Output 0
 * 
 * true Explanation 0
 * 
 * pushed = [1,2,3,4,5] popped = [4,5,3,2,1] Explanation: We might do the
 * following sequence: push(1), push(2), push(3), push(4), pop() -> 4, push(5),
 * pop() -> 5, pop() -> 3, pop() -> 2, pop() -> 1 Sample Input 1
 * 
 * 5 1 2 3 4 5 4 3 5 1 2 Sample Output 1
 * 
 * false Explanation 1
 * 
