...
public class D_PathSum {
    ...
    // We use PreOrder Traversal cauz we want to return the answer as soon as we
    // find it
 ...
 * Add to List
 * 
 * Share Given the root of a binary tree and an integer targetSum, return true
 ...
 * 
 * 
 * Input: root = [1,2,3], targetSum = 5 Output: false Example 3:
 * 
