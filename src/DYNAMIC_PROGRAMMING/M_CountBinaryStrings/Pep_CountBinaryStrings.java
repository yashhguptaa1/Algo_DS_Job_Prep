package DYNAMIC_PROGRAMMING.M_CountBinaryStrings;
...
public class Pep_CountBinaryStrings {
    ...
    public static int countBinaryStrings_memo(int n, int lastEleAppended, int[][] dp) {
        ...
        if (dp[n][lastEleAppended] != 0)
            return dp[n][lastEleAppended];
 ...
 * binary strings of length n with no consecutive 0's. Sample Input 6 Sample
 * Output 21
 */
