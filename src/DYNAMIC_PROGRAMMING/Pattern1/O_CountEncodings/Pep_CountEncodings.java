package DYNAMIC_PROGRAMMING.Pattern1.O_CountEncodings;
...
/*
 * 1. You are given a string str of digits. (will never start with a 0) 2. You
 * are required to encode the str as per following rules 1 -> a 2 -> b 3 -> c ..
 * 25 -> y 26 -> z 3. You are required to calculate and print the count of
 * encodings for the string str.
 * 
 * For 123 -> there are 3 encodings. abc, aw, lc For 993 -> there is 1 encoding.
 * iic
 * 
 * Sample Input 123 Sample Output 3
 */