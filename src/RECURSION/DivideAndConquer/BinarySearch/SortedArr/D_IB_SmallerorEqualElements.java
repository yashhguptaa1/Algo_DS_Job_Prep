 ...
 * Problem Description
 * 
 * Given an sorted array A of size N. Find number of elements which are less
 * than or equal to B.
 * 
 ...
 * 
 * 
 * Input Format First agument is an integer array A of size N.
 * 
 * Second argument is an integer B.
 * 
 * 
 * 
 * Output Format Return an integer denoting the number of elements which are
