    ...
    public int searchInsert(ArrayList<Integer> a, int b) {
        ...
        while (low <= high) {
            ...
            if (b == a.get(mid))
                 ...
                 * A = [1, 3, 5, 6] B = 2
                 * 
                 * Note we would insert 2 at index 1 Index 1 is the ceil index for given element
                 * 2
                 * 
                 * ceil index is updated as we are going towards left when we find element at
                 * mid is greater than current element
                 */
                ceilIdx = mid;
                high = mid - 1;
