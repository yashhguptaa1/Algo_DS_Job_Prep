...
public class GetAllKPC {
    ...
    // Basically using Recursion we are reaching the last character and getting an
    // empty bucket
    // now while going back( popping the recursive call from stack) we make
    // arraylist and update ans
